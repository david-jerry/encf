...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres:///encryptfinance2"),
}
...
LOCAL_APPS = [
    "encryptfinance.users",
    "encryptfinance.contracts",
    "encryptfinance.management",
    "encryptfinance.wallet",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "encryptfinance.users.context_processors.allauth_settings",
                "encryptfinance.utils.context_processors.context_data",
            ],
        },
    }
]
...
ADMINS = [("""Daniel Pigguet""", "admin@encryptfinance.net")]
...
ACCOUNT_FORMS = {
    "signup": "encryptfinance.users.forms.UserSignupForm"
}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
...
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {
    "signup": "encryptfinance.users.forms.UserSocialSignupForm"
}
